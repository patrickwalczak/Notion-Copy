...
export default function NotFound() {
	return (
		<div className={`${styles.wrapper} flex-center`}>
			<div className={`${styles.container} flex-column p-x-1`}>
				...
				<main className={`${styles.main} flex-center flex-column gap-050 flex-grow-1`}>
					<p className={`${styles.messagePrimary} p-x-050`}>This page couldn’t be found</p>
					<p className={`${styles.messageSecondary} p-x-050`}>
